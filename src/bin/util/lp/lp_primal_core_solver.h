...
public:
    ...
    void one_iteration_tableau_rows() {
        ...
        //int sizeOfm_x = this->m_x.size();
        //X feas_sol = this->m_x[4];
        /*for(int j = 0; j<this->m_x.size(); j++){
        	X feas_sol = this->m_x[j];
        }*/
        /*for (int cid = 0; cid < this->m_column_types.size(); cid++){
        	std::string colName = this->column_name(cid);
        }*/
