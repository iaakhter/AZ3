...
#define DEEP_EXPR_THRESHOLD 1024
    ...
    */
    void context::internalize_assertion(expr * n, proof * pr, unsigned generation) {
    	//std::cout << "internalize_assertion " <<  mk_pp(n, m_manager) << "\n";
        ...
        //std::cout << "generation " << "generation: " << m_generation << "\n";
        ...
        //std::cout << "size of m_atom_propagation_queue after ctc()::internalize_assertion " <<
    ...
    void context::assert_default(expr * n, proof * pr) {
        ...
        if (l == false_literal) {
        	...
        	//std::cout << "smt_internalizer: assert_default eq: " << mk_pp(n, m_manager) << "\n";
...
#define DISTINCT_SZ_THRESHOLD 32
    ...
    */
    void context::internalize_formula(expr * n, bool gate_ctx) {
        ...
        //std::cout << "SMT_INTERNALIZER::internalize_formula " << mk_pp(n,m_manager) << "\n";
        SASSERT(m_manager.is_bool(n));
    ...
    */
    void context::internalize_formula_core(app * n, bool gate_ctx) {
    	//std::cout << "SMT_INTERNALIZER::internalize_formula_core " << mk_pp(n,m_manager) << "\n";
        SASSERT(!b_internalized(n));
        SASSERT(!e_internalized(n));
    ...
    */
    bool_var context::mk_bool_var(expr * n) {
        //std::cout << "internalizing expr in smt_internalizer.cpp: " << mk_pp(n,m_manager) << "\n";
    	SASSERT(!b_internalized(n));
    ...
    */
    clause * context::mk_clause(unsigned num_lits, literal * lits, justification * j, clause_kind k, clause_del_eh * del_eh) {
        ...
        /*std::cout << "mk_clause " << "creating clause:\n";
        display_literals_verbose(std::cout, num_lits, lits);
        std::cout << "\n";
        std::cout << "justification " << j << "\n";*/
        switch (k) {
        case CLS_AUX: {
