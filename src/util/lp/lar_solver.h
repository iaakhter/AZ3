...
#include "util/lp/init_lar_solver.h"
    ...
    */
    ...
    //ITRAT
    std::unordered_map<unsigned, lean::var_index> getColToExtVar(){
    	return m_ext_vars_to_columns;
    }

    //ITRAT
    vector<lar_term*> getOrigTerm(){
    	return m_orig_terms;
    }
    ...
    void solve_with_core_solver() {
        ...
        //int sizeOfm_x = m_mpq_lar_core_solver.m_r_solver.m_x.size();
    }
